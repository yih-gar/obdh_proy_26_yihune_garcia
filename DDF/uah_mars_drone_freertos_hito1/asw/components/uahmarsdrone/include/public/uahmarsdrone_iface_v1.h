#ifndef UAHMARSDRONE_H_
#define UAHMARSDRONE_H_
 ...
 *
 */
class UAHMarsDrone: public CEDROOMComponent {

public:

	/**
	 * \enum TEDROOMUAHMarsDroneSignal
	...
	//! Constructor
	UAHMarsDrone(TEDROOMComponentID id, TEDROOMUInt32 roomNumMaxMens, TEDROOMPriority roomtaskPrio, 
...
public:
	...
	enum TEDROOMUAHMarsDroneSignal { EDROOMSignalTimeout,
		...
		//!Constructor
		EDROOM_CTX_Top_0 (UAHMarsDrone &act,
	...
	public:
		...
		//! Constructor
		EDROOM_SUB_Top_0 (UAHMarsDrone &act );
