...
/*PROTECTED REGION ID(public_edroomsl_iface_h) ENABLED START*/
/**
 *  @addtogroup ICUSW_SERVICE_MODULES ICUSw Service Modules
 *  @{
 */
/**
 *  @defgroup EDROOMSL EDROOM SERVICE LIBRARY
 *  @{
 */
...
public:
    ...
    */
	...
	TEDROOMInt32 RegisterInterface( TEDROOMInterfaceID id
	            , CEDROOMInterface & interface
	            , CEDROOMComponent* pComponent, const char *){
	    return RegisterInterface( id
	              , interface
	              , pComponent);
...
public:
  ...
  CEDROOMComponent( const char * name, TEDROOMComponentID componentID,
                  TEDROOMUInt16 prioNum,
                  TEDROOMUInt32 maxNumMsgInQueue,
                  TEDROOMPriority taskPriority,
                  TEDROOMUInt32 stack,
