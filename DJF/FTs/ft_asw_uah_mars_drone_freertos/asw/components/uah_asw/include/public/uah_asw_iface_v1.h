 ...
 *
 */
class UAH_ASW: public CEDROOMComponent {

public:

	/**
	 * \enum TEDROOMUAH_ASWSignal
	 * \brief Component Signal Enum Type
	 *
	 */
	 enum TEDROOMUAH_ASWSignal { EDROOMSignalTimeout, 
							EDROOMSignalDestroy };

	/**
	 * \class UAH_ASW::CEDROOMMemory
	...
	//! Constructor
	UAH_ASW(TEDROOMComponentID id, TEDROOMUInt32 roomNumMaxMens, TEDROOMPriority roomtaskPrio, 
...
public:
	...
	enum TEDROOMUAH_ASWSignal { EDROOMSignalTimeout,
		...
		friend class UAH_ASW;

		//!component reference
		UAH_ASW &EDROOMcomponent;
