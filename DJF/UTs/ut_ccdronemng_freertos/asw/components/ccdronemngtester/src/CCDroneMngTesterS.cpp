...
CCDroneMngTester::CCDroneMngTester(TEDROOMComponentID id,
...
int CCDroneMngTester::EDROOMConfig()
{
...
int CCDroneMngTester::EDROOMStart()
{
...
void CCDroneMngTester::EDROOMBehaviour()
{
...
bool CCDroneMngTester::EDROOMIsComponentFinished()
{
...
void CCDroneMngTester::CEDROOMMemory::SetMemory(TEDROOMUInt32 numMessages_ ,
